# Implementação do algoritmo de agendamento por ordem de chegada
# Neste algoritmo, nós apenas nos preocupamos com a ordem em que os processos chegaram
# sem se preocupar com seu tempo de duração
